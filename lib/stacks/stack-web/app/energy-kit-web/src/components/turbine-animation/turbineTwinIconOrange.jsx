...
function TurbineAnimation(props) {
  //const [toggle, setToggle] = useState(false);
  const blades = [
    <Blades key="blades" />
  ]
  let rpm = props.telemetry.rpm;
  let bladeColor = "white";
  let turbine_id = props.telemetry.sensorId;
  ...
  >
    ...
    <g>
      ...
      >
        ...
        />
        <circle id="nacelle" fill="orange" cx={36.54} cy={12} r={11.93} />
        <circle
          id="gearbox"
          fill="none"
          stroke="#d0d6d7"
