...
const state = store({
  iotPolicy: 'amplify-iot-pubsub-policy',     // This policy is created by this Amplify project; you don't need to change this unless you want to use a different policy.  
...
export default IotPubSubWidget; 