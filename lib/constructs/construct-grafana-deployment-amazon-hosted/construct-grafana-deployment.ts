...
export class GrafanaDeploymentAmazonHosted extends Construct {
  public readonly dashboardUrl: string;

  constructor(scope: Construct, id: string, props: GrafanaProps) {
    super(scope, id);
    const { twinmakerId, assetName } = props;
    ...
    const dashboard = new GeneralDashboard(this, 'GeneralDashboard', { assetName, endpoint, apiKey, datasourceId: datasource.id });
